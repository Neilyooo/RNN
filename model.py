...
class Model():
    def __init__(self, learning_rate=0.001, batch_size=16, num_steps=32, num_words=5000, dim_embedding=128, rnn_layers=3, keep_prob=0.8):
        r"""初始化函数
    ...
    def build(self, embedding_file=None):
        ...
        with tf.variable_scope('rnn'):            
            ...
            data维度[5000,128]
            """
            output, self.outputs_state_tensor = tf.nn.dynamic_rnn(cell, data, initial_state=self.state_tensor)#outputs_state_tensor网络最后一个state
